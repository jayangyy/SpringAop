...
//
//    public EduInvocationSecurityMetadataSourceService(IUserdao testDao) {
...
//        List<String> query = this.testDao.getAllAuthorityName();//list<role>
//
//        /*
...
//
//            List<String> query1 = this.testDao.getResource(auth);//list<resource>
//
